...
const PeopleIndex = ({ match}) =>(
    <Switch>
        ...
        <Route path={`${match.url}/discountlist`} component={DiscountList} />
        <Route path={`${match.url}/adddiscount`} component={AddDiscount} />
        <Route path={`${match.url}/editdiscount`} component={EditDiscount} />
